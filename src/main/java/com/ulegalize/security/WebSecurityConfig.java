...
import com.ulegalize.security.handler.ForbiddenHandler;
import com.ulegalize.security.handler.UnauthorizedHandler;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Bean
    @Profile({"dev", "devDocker", "integrationtest"})
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.cors().and()
                ...
                // allow auth url
                .antMatchers("/dpa/**").permitAll()
                .antMatchers("/**/finish").permitAll()
                .antMatchers("/v2/**/finish").permitAll()
